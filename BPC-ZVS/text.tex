...
Nezávislé na pozici:
\begin{figure}
    \includegraphics[scale = 0.13]{img/transf_krivka.png}
\end{figure}
...
\end{itemize}
\begin{figure}
    \includegraphics[scale = 0.25]{img/konvoluce_maska.png}
\end{figure}
...
\end{itemize}
\begin{figure}
    \includegraphics[scale = 0.7]{img/hrany.png}
\end{figure}
...
\end{itemize}
\begin{figure}
    \includegraphics[scale = 0.3]{img/segmentace.png}
\end{figure}
...
\begin{figure}
    \includegraphics[scale = 0.3]{img/chain_codes.png}
\end{figure}
...
\begin{figure}
    \includegraphics[scale = 0.2]{img/geometricky_popis.png}
\end{figure}
\newpage
...
\begin{figure}
    \includegraphics[scale = 0.2]{img/priznakove.png}
\end{figure}
...
\begin{figure}
    \includegraphics[scale = 0.7]{img/syntakticke.png}
\end{figure}
